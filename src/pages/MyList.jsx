        ...
        <div className="overflow-x-auto font-[sans-serif]">
            <table className="min-w-full bg-white">
                ...
                <tbody className="whitespace-nowrap">
                    ...
                    {spotCard.map((card) => (
                        <tr key={card._id} className="even:bg-blue-50">
                            ...
                            <td className="p-4 text-sm">
                                <img src={card.image} alt="Spot" className="w-24 h-12" />
                            </td>
                            <td className="p-4 text-sm">
                                {card.spotsName}
                            </td>
                            ...
                            <td className="p-4">
                                <Link to={`/myListCardUpdate/${card._id}`}>
                                ...
                                <button onClick={() => handleDelete(card._id)} className="mr-4" title="Delete">

...
import gallery10 from '../assets/photoGallery/img10.jpg'
        ...
        <div className="md:px-10 lg:px-3  rounded-2xl mt-5">
            ...
            <section className="py-6 dark:bg-gray-100 dark:text-gray-900">
                <div className="space-y-5">
                    ...
                    <p className="text-center" >Discover the globes wonders through our World Tourism Photo Gallery. From serene beaches to towering mountains, <br /> embark on a visual journey spanning cultures and landscapes in 30 captivating images</p>
                </div>
                <div className="container grid grid-cols-2 gap-4 p-4 mx-auto md:grid-cols-4">
                        ...
                        <img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square" src={gallery10} />

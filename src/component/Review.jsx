    ...
    return (
        <div className="md:px-10 lg:px-3  rounded-2xl mt-5">
            ...
            <p className="text-center mt-2 mb-3" data-aos="fade-left"
                ...
                data-aos-offset="500" data-aos-duration="3000">Impeccable service and attention to detail! The tour exceeded all expectations, offering unique experiences and unforgettable memories. <br />Highly recommended for discerning travelers seeking exceptional adventures</p>
